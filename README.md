...
[Magento 2 Product Grid Inline Editor](https://www.ulmod.com/magento-2-product-grid-editor.html) is a Magento 2 extension that allows you to update product data right from the grid. You can edit one or multiple products data from the product grid in one go. 

With the Magento 2 Product Grid Inline Editor extension, you can save time on managing products in your backend. No more need to update product data one per one.
...
* Organize product attributes into three tabs columns to easily manage
* Work with custom filters 
* Ability to save grid editing state to a template for easy re-use. Create one or multiple templates in grid
* Ability to rename column header. Mark editable column with icon, Drag & Drop Columns in the grid. 
* Ability to update one or multiple data of the product in the grid. Support AJAX update for a quick edit, no page reload 
* Work all product attribute input types
* Show Related, Cross-sells, Up-sell products in the grid. Ability to define the max number of items to display in the grid
* Ability to update Categories of products from the grid
* Ability to upload and remove product images and videos from the grid
* Ability to edit product quantities, stock, availability from the grid 
* Ability to remove Decimal From Quantity in the grid
* Ability to show the total quantities of each product sold in the grid. Define the start/end date to count quantity sold that display in the grid
* Ability to  edit/update many product data from the grid, such as price, and more


<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/grid-tabs.png">
<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/filters-template.png">
<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/single-multi-cells.png">
<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/product-links.png">
<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/categories-edit.png">
<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/image-video-edit.png">
<img src="https://www.ulmod.com//media/ulmod_products/productgrideditor/quantity-edit-sold.png">
